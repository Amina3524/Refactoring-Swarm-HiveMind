    ...
    def _process_file(self, file_path: str) -> Dict:
        ...
        try:
            ...
            log_experiment(
                ...
                details={
                    "input_prompt": f"Starting processing of {Path(file_path).name}",
                    "output_response": f"File size: {len(content)} chars"
                },
                status="INFO"
            )
            ...
            log_experiment(
                ...
                action=ActionType.ANALYSIS,
                details={
                    "input_prompt": f"Completed processing of {Path(file_path).name}",
                    "output_response": f"Phase: {final_phase}, Iterations: {iterations}, Success: {success}"
                },
            ...
            log_experiment(
                ...
                details={
                    "input_prompt": f"Error processing {Path(file_path).name}",
