...
class FileTools:
    ...
    def __init__(self, sandbox_dir: str = "sandbox"):
        ...
        print(f"🔒 File tools initialized with sandbox: {self.sandbox_dir}")
    ...
    def read_file(self, file_path: str) -> str:
        ...
        try:
            with open(path, 'r', encoding='utf-8') as f:
                content = f.read()
            print(f"📖 Read file: {path.name} ({len(content)} chars)")
            return content
    ...
    def write_file(self, file_path: str, content: str) -> bool:
        ...
        try:
            ...
            print(f"💾 Wrote file: {path.name} ({len(content)} chars)")
            return True
    ...
    def copy_to_sandbox(self, source_path: str) -> str:
        ...
        print(f"📋 Copied to sandbox: {source.name}")
